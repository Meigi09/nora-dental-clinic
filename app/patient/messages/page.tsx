  ...
  const chats = [
    {
      id: 1,
      name: "Dr. James Smith",
      lastMessage: "Your treatment is progressing well",
    ...
    },
    {
      ...
      lastMessage: "Follow up appointment scheduled",
      timestamp: "Yesterday",
      unread: false,
      avatar: "SW",
    },
  ...
  const messages = [
    {
      ...
      text: "Hi John, your cavity treatment is healing well. Continue taking your prescribed medications.",
      time: "1:30 PM",
      isMe: false,
    },
    {
      id: 2,
      sender: "You",
      text: "Thank you doctor! The pain is much better now.",
      time: "1:45 PM",
      isMe: true,
    },
    {
      id: 3,
      sender: "Dr. James Smith",
      text: "Great! Your treatment is progressing well",
      time: "1:50 PM",
      isMe: false,
    },
  ];
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-700 mt-2">
            Communicate with our clinic and doctors
          </p>
        </div>

        {/* Messaging Interface */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-96 md:h-[500px]">
          {/* Chat List */}
